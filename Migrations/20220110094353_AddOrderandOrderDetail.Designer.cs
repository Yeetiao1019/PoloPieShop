...
namespace PoloPieShop.Migrations
{
    ...
    [Migration("20220110094353_AddOrderandOrderDetail")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PoloPieShop.Models.Category", b =>
                {
            ...
            modelBuilder.Entity("PoloPieShop.Models.Order", b =>
                {
            ...
            modelBuilder.Entity("PoloPieShop.Models.OrderDetail", b =>
                {
            ...
            modelBuilder.Entity("PoloPieShop.Models.Pie", b =>
                {
                    b.Property<int>("PieId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PoloPieShop.Models.ShoppingCartItem", b =>
                {
            ...
            modelBuilder.Entity("PoloPieShop.Models.OrderDetail", b =>
                {
                    b.HasOne("PoloPieShop.Models.Order", "Order")
                        .WithMany("OrderDetails")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PoloPieShop.Models.Pie", "Pie")
                        .WithMany()
                        .HasForeignKey("PieId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("PoloPieShop.Models.Pie", b =>
                {
                    b.HasOne("PoloPieShop.Models.Category", "Category")
                        .WithMany("Pies")
